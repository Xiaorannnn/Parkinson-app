...
class _ParticipantQuestionState extends State<ParticipantQuestion> {
  ...
  Widget buildNextButton(BuildContext context, Size screenSize) {
    return ElevatedButton(
        ...
        child: Text(AppLocalizations.of(context)!.survey_next,
            // "Next",
  ...
  void handleNextPressed() {
    if (participantAnswer != "") {
      Navigator.of(context).pushNamed(widget.routeNameOfNextWidget,
          arguments: {'participantAnswer': participantAnswer});
    } else {
